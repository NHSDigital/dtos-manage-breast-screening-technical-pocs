...
echo "=================================================="
echo "Go DICOM PACS Server - Initialization"
echo "=================================================="
echo ""
echo "Configuration:"
...
TABLE_EXISTS=$(sqlite3 "$DB_PATH" "SELECT name FROM sqlite_master WHERE type='table' AND name='stored_instances';" 2>/dev/null || echo "")

if [ -z "$TABLE_EXISTS" ]; then
    echo "Database tables not found. Initializing PACS database..."

    if [ -f "$INIT_SQL" ]; then
        sqlite3 "$DB_PATH" < "$INIT_SQL"
        echo "Database initialized successfully"
    else
        echo "Warning: init_pacs_db.sql not found, creating empty database"
...
echo ""
echo "=================================================="
echo "Starting Go DICOM PACS Server..."
echo "=================================================="
echo ""
