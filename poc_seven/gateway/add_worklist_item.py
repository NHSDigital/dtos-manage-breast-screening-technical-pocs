...
Usage:
    python add_worklist_item.py --accession ACC123 --patient-id BS123456 \\
        --patient-name "SMITH^JOHN" --birth-date 19800101 --sex M \\
...
# Add scripts directory to path to import WorklistStorage
...
def main():
    parser = argparse.ArgumentParser(
        description='Add a worklist item to the database',
